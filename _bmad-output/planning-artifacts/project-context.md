...
| lurus-lucrum | gushen.lurus.cn | 8870 | Next.js+Python | gushen | Production |
...
|---------|-----------|-----------|----------|------|
| lucrum-web | ai-qtrd-staging | staging | db:3 | cloud-ubuntu-1 (master) |
...
- Namespace convention: `lucrum` (lucrum prod), `ai-qtrd-staging` (lucrum staging), `lurus-system` (api), `mail` (webmail)
